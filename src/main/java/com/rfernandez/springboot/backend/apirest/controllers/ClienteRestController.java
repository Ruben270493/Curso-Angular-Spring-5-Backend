package com.rfernandez.springboot.backend.apirest.controllers;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
		...
		response.put("mensaje", "¡El cliente " + newCliente.getNombre() + " ha sido creado con éxito!");
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, @PathVariable Long id, BindingResult result) {
		...
		response.put("mensaje", "¡El cliente " + clienteUpdated.getNombre() + " ha sido actualizado con éxito!");
